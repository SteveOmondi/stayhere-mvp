...
resource "azurerm_api_management_api_operation" "op_customer_writelog" {
...
resource "azurerm_api_management_api_operation_policy" "pol_customer_writelog" {
  api_name            = azurerm_api_management_api_operation.op_customer_writelog.api_name
  api_management_name = azurerm_api_management_api_operation.op_customer_writelog.api_management_name
  resource_group_name = azurerm_api_management_api_operation.op_customer_writelog.resource_group_name
  operation_id        = azurerm_api_management_api_operation.op_customer_writelog.operation_id
  xml_content         = <<XML
<policies>
    <inbound>
        <base />
...
resource "azurerm_api_management_api_operation" "op_customer_readlog" {
...
resource "azurerm_api_management_api_operation_policy" "pol_customer_readlog" {
  api_name            = azurerm_api_management_api_operation.op_customer_readlog.api_name
  api_management_name = azurerm_api_management_api_operation.op_customer_readlog.api_management_name
  resource_group_name = azurerm_api_management_api_operation.op_customer_readlog.resource_group_name
  operation_id        = azurerm_api_management_api_operation.op_customer_readlog.operation_id
  xml_content         = <<XML
<policies>
    <inbound>
        <base />
