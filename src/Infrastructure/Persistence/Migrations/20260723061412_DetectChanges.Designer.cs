...
namespace StayHere.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260723061412_DetectChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StayHere.Domain.Entities.Listing", b =>
                {
                    ...
                    b.Property<string>("StructuredImages")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("images_structured");
            ...
            modelBuilder.Entity("StayHere.Domain.Entities.Property", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rules = "[]",
                            SharedAmenities = "[]",
                            StructuredImages = "{\"Exterior\":[],\"CommonAreas\":[],\"Other\":[]}",
                            TotalFloors = 10,
                            TotalUnits = 50,
                            UpdatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
            ...
            modelBuilder.Entity("StayHere.Domain.Entities.PropertyTerms", b =>
                {
                    ...
                    b.Property<decimal?>("ElectricityDeposit")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("electricity_deposit");

                    b.Property<decimal?>("GarbageDeposit")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("garbage_deposit");
                    ...
                    b.Property<string>("MinimumLeasePeriod")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("min_lease_period");
                    ...
                    b.Property<decimal?>("TokenDeposit")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("token_deposit");

                    b.Property<DateTime>("UpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("updated_at");

                    b.Property<decimal?>("WaterDeposit")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("water_deposit");
            ...
            modelBuilder.Entity("StayHere.Domain.Entities.Subcategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("StayHere.Domain.Entities.Listing", b =>
                {
                    ...
                    b.OwnsOne("StayHere.Domain.Entities.PropertyContact", "Caretaker", b1 =>
                        {
                            b1.Property<Guid>("ListingId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<string>("Email")
                                .HasMaxLength(255)
                                .HasColumnType("character varying(255)")
                                .HasColumnName("caretaker_email");

                            b1.Property<string>("Name")
                                .IsRequired()
                                .HasMaxLength(255)
                                .HasColumnType("character varying(255)")
                                .HasColumnName("caretaker_name");

                            b1.Property<string>("Phone")
                                .IsRequired()
                                .HasMaxLength(20)
                                .HasColumnType("character varying(20)")
                                .HasColumnName("caretaker_phone");
