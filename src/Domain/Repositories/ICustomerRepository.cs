...
public interface ICustomerRepository
{
    ...
    Task<IReadOnlyList<Customer>> GetByOwnerAsync(Guid ownerId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Customer>> GetByPropertyAsync(Guid propertyId, CancellationToken cancellationToken = default);
